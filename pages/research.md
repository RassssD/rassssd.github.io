...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 0 0 50%; max-width: 50%; margin-left: 20px;">
    <img src="/resources/images/Estonia_fertility_DID.png" alt="MSc Dissertation Bunch" style="max-width: 100%; height: auto;">
  </div>
</div>
...
1. [For whom the constraint binds? Behavioural Responses to the Removal of Income Limits for Study Aid in Sweden under COVID-19](/resources/papers/MSc_Dissertation_RasmusDuret.pdf) <br>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 0 0 50%; max-width: 50%; margin-left: 20px;">
    <img src="/resources/images/MSc_Dissertation_Bunch.png" alt="MSc Dissertation Bunch" style="max-width: 100%; height: auto;">
  </div>
</div>

---

2. [Unravelling Network Capital: Exposure and Friending Effects in a network-based model of Moving to Opportunity](/resources/papers/BSc_Dissertation_RasmusDuret.pdf) <br> BSc Dissertation, May 2022
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 0 0 50%; max-width: 70%;">
    <button class="accordion"> Abstract </button> 
    <div class="panel" style="background-color: #F1F1F1; color: #666; padding: 10px;"> 
  ...
  <div style="flex: 0 0 50%; max-width: 50%; margin-left: 20px;">
    <img src="/resources/images/BSc_Dissertation_Graph.png" alt="MSc Dissertation Bunch" style="max-width: 100%; height: auto;">
  </div>
</div>
